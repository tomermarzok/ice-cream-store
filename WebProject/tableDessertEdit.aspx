<%@ Page Title="" Language="C#" MasterPageFile="~/MainPage.Master" AutoEventWireup="true" CodeBehind="tableDessertEdit.aspx.cs" Inherits="WebProject.tableDessertEdit" %>
    ...
    <table class="auto-style3">
        <tr>
            ...
            <td>
                ...
                <asp:Label ID="dessertTableLb" runat="server" Text="טבלת קינוחים"></asp:Label>
            </td>
        </tr>
        <tr>
            <td>&nbsp;</td>
            <td>
                ...
                <asp:GridView ID="GVcontactDet" HorizontalAlign="Center" runat="server" Height="209px" Width="687px" AutoGenerateColumns="False" DataKeyNames="Id" DataSourceID="SDdessertPrice">
                    <Columns>
